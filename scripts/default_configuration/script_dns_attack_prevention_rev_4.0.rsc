/system script add comment=def2conf name="dns_attack_prevention_rev_4.0" source=":do {
/ip firewall/address-list/remove [find list=\"LAN Addresses (RFC1918)\"]
/ip firewall/address-list/remove [find list=\"DNS Servers\"]
/ip firewall address-list {
add address=10.0.0.0/8 comment=\"def2conf: dns_attack\" list=\"LAN Addresses (RFC1918)\";
add address=172.16.0.0/12 comment=\"def2conf: dns_attack\" list=\"LAN Addresses (RFC1918)\";
add address=192.168.0.0/16 comment=\"def2conf: dns_attack\" list=\"LAN Addresses (RFC1918)\";
...
add action=accept chain=DNS_INPUT comment=\"def2conf: dns_attack Make exceptions for LAN DNS inquiries\" port=53 protocol=udp src-address-list=\"LAN Addresses (RFC1918)\";
add action=add-src-to-address-list address-list=DNS_DDoS address-list-timeout=none-dynamic chain=DNS_INPUT comment=\"def2conf: dns_attack Add other DNS inquiries to DNS_DDoS Offenders List\" port=53 protocol=udp src-address-list=\"!LAN Addresses (RFC1918)\"
...
add action=accept chain=DNS_OUTPUT comment=\"def2conf: dns_attack Make Exceptions for Traffic to the DNS Servers\" dst-address-list=\"DNS Servers\" dst-port=53 protocol=udp;
...
add action=accept chain=DNS_FORWARD comment=\"def2conf: dns_attack Make Exceptions for Trafffic from the DNS Servers going to the LAN\" dst-address-list=\"LAN Addresses (RFC1918)\" port=53 protocol=udp src-address-list=\"DNS Servers\";
add action=accept chain=DNS_FORWARD comment=\"def2conf: dns_attack Make Exceptions for Traffic from the LAN going to the DNS Servers\" dst-address-list=\"DNS Servers\" port=53 protocol=udp src-address-list=\"LAN Addresses (RFC1918)\";
